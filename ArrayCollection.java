...
public class ArrayCollection<T> implements CollectionInterface<T>  {
	...
	// not successful, sets found to false.
	{
	 ...
	 //toString() method which prints out the collection
	 ...
	 //count method counts the number of animals of the particular name 
	...
	//remove all method removes all the elements from the collection
